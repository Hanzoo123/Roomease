...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('admin/dashboard.php') ?>" class="brand-link">
    <img src="<?= base_url('AdminLTE/dist/img/AdminLTELogo.png') ?>" alt="RoomEase Logo"
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="<?= base_url('admin/dashboard.php') ?>" class="d-block font-weight-bold text-truncate"
          style="max-width: 160px;" title="<?= h($adminName) ?>">
          <?= h($adminName) ?>
        </a>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
        ...
        <li class="nav-item">
          <a href="<?= base_url('admin/manage_listings.php') ?>"
            class="nav-link <?= $currentPage === 'manage_listings.php' ? 'active' : '' ?>">
